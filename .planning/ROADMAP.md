...
Plans:
- [ ] 01-01-PLAN.md — Project scaffold, build toolchain, tesseract.js bundling, popup UI
- [ ] 01-02-PLAN.md — Selection box overlay with draw, resize, and coordinate tracking
