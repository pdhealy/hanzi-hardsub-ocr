...
```bash
node "/workspace/.claude/get-shit-done/bin/gsd-tools.cjs" validate health $REPAIR_FLAG
```
...
```bash
node "/workspace/.claude/get-shit-done/bin/gsd-tools.cjs" validate health
```
